...
addon_id = 'plugin.video.Back_In_Time'
...
def scrape_movie(url):
    addDir('[COLORblue][B]MOVIES BY GENRE[/B][/COLOR]','',1002,'http://2.bp.blogspot.com/_s8fgo2oOrGA/TJniXdGtoJI/AAAAAAAAAHM/EE43v4CdIU4/s1600/5803926-movie-poster-of-film-genres-vintage-background.jpg',FANART,'','','','')
    addDir('[COLORblue][B]MOVIES BY YEAR[/B][/COLOR]','',1004,'https://e.snmc.io/lk/l/s/5b799d8ed01a5bbcfa9dd2bb0290b642/5942704.png',FANART,'','','','')
        ...
        for source in frame:
            ...
            for a,b,c,d,link in match:
                if a == 'xyz':
                    ...
                    PLAY(name,fin_url,1001,img,img,'','')
                else:
                    fin_url = 'http://'+d+'.'+c+'.'+b+'.'+a+'/hls/,'+link+',.urlset/master.m3u8'
                    PLAY(name,fin_url,1001,img,img,'','')
    for nxt in Next:
        addDir('[COLORblue][B]NEXT[/B][/COLOR]',nxt,1000,'',FANART,'','','','')
        


def movie_genre():
    addDir('[COLORblue][B] ACTION[/B][/COLOR]','http://onlinemoviescinema.com/genre/action/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] ADVENTURE[/B][/COLOR]','http://onlinemoviescinema.com/genre/adventure/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] ANIMATION[/B][/COLOR]','http://onlinemoviescinema.com/genre/animation/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] COMEDY[/B][/COLOR]','http://onlinemoviescinema.com/genre/comedy/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] CRIME[/B][/COLOR]','http://onlinemoviescinema.com/genre//',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] DOCUMENTARY[/B][/COLOR]','http://onlinemoviescinema.com/genre/documentary/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] DRAMA[/B][/COLOR]','http://onlinemoviescinema.com/genre/drama/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] FAMILY[/B][/COLOR]','http://onlinemoviescinema.com/genre//family',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] FANTASY[/B][/COLOR]','http://onlinemoviescinema.com/genre/fantasy/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] FOREIGN[/B][/COLOR]','http://onlinemoviescinema.com/genre/foreign/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] HISTORY[/B][/COLOR]','http://onlinemoviescinema.com/genre/history/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] HORROR[/B][/COLOR]','http://onlinemoviescinema.com/genre/horror/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] MUSIC[/B][/COLOR]','http://onlinemoviescinema.com/genre/music/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] MYSTERY[/B][/COLOR]','http://onlinemoviescinema.com/genre/mystery/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] ROMANCE[/B][/COLOR]','http://onlinemoviescinema.com/genre/romance/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] SCIENCE FICTION[/B][/COLOR]','http://onlinemoviescinema.com/genre/science-fiction/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] SPORTS[/B][/COLOR]','http://onlinemoviescinema.com/genre/sports/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] THRILLER[/B][/COLOR]','http://onlinemoviescinema.com/genre/thriller/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] TV MOVIE[/B][/COLOR]','http://onlinemoviescinema.com/genre/tv-movie/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] WAR[/B][/COLOR]','http://onlinemoviescinema.com/genre/war/',1003,'',FANART,'','','','')
    addDir('[COLORblue][B] WESTERN[/B][/COLOR]','http://onlinemoviescinema.com/genre/western/',1003,'',FANART,'','','','')
    

def scrape_movie_genre(url,name):
    addDir(name,'','','',FANART,'','','','')
    addDir('[COLORblue][B]BACK TO GENRES[/B][/COLOR]','',1002,'http://2.bp.blogspot.com/_s8fgo2oOrGA/TJniXdGtoJI/AAAAAAAAAHM/EE43v4CdIU4/s1600/5803926-movie-poster-of-film-genres-vintage-background.jpg',FANART,'','','','')
    html = requests.get(url).text
    Next = re.compile('<li><a class="next page-numbers" href="(.+?)">Next .+?</a>',re.DOTALL).findall(html)
    ...
    for nxt in Next:
        addDir('[COLORblue][B]NEXT[/B][/COLOR]',nxt,1003,'',FANART,'','','','')

        
def scrape_year():
    addDir('[COLORblue][B]2017[/B][/COLOR]','http://onlinemoviescinema.com/watch-2017-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2016[/B][/COLOR]','http://onlinemoviescinema.com/watch-2016-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2015[/B][/COLOR]','http://onlinemoviescinema.com/watch-2015-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2014[/B][/COLOR]','http://onlinemoviescinema.com/watch-2014-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2013[/B][/COLOR]','http://onlinemoviescinema.com/watch-2013-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2012[/B][/COLOR]','http://onlinemoviescinema.com/watch-2012-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2011[/B][/COLOR]','http://onlinemoviescinema.com/watch-2011-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2010[/B][/COLOR]','http://onlinemoviescinema.com/watch-2010-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2009[/B][/COLOR]','http://onlinemoviescinema.com/watch-2009-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2008[/B][/COLOR]','http://onlinemoviescinema.com/watch-2008-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2007[/B][/COLOR]','http://onlinemoviescinema.com/watch-2007-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2006[/B][/COLOR]','http://onlinemoviescinema.com/watch-2006-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2005[/B][/COLOR]','http://onlinemoviescinema.com/watch-2005-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2004[/B][/COLOR]','http://onlinemoviescinema.com/watch-2004-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2003[/B][/COLOR]','http://onlinemoviescinema.com/watch-2003-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2002[/B][/COLOR]','http://onlinemoviescinema.com/watch-2002-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2001[/B][/COLOR]','http://onlinemoviescinema.com/watch-2001-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]2000[/B][/COLOR]','http://onlinemoviescinema.com/watch-2000-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1999[/B][/COLOR]','http://onlinemoviescinema.com/watch-1999-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1998[/B][/COLOR]','http://onlinemoviescinema.com/watch-1998-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1997[/B][/COLOR]','http://onlinemoviescinema.com/watch-1997-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1996[/B][/COLOR]','http://onlinemoviescinema.com/watch-1996-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1995[/B][/COLOR]','http://onlinemoviescinema.com/watch-1995-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1994[/B][/COLOR]','http://onlinemoviescinema.com/watch-1994-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1993[/B][/COLOR]','http://onlinemoviescinema.com/watch-1993-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1992[/B][/COLOR]','http://onlinemoviescinema.com/watch-1992-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1991[/B][/COLOR]','http://onlinemoviescinema.com/watch-1991-movies/',1005,'',FANART,'','','','')
    addDir('[COLORblue][B]1990[/B][/COLOR]','http://onlinemoviescinema.com/watch-1990-movies/',1005,'',FANART,'','','','')
    
    
     
def scrape_movie_year(url,name):
    addDir(name,'','','',FANART,'','','','')
    addDir('[COLORblue][B]BACK TO YEARS[/B][/COLOR]','',1004,'https://e.snmc.io/lk/l/s/5b799d8ed01a5bbcfa9dd2bb0290b642/5942704.png ',FANART,'','','','')
    html = requests.get(url).text
    Next = re.compile('<li><a class="next page-numbers" href="(.+?)">Next .+?</a>',re.DOTALL).findall(html)
    ...
    for nxt in Next:
        addDir('[COLORblue][B]NEXT[/B][/COLOR]',nxt,1005,'',FANART,'','','','')
...
def SKindex():
    addon_log("SKindex")
    addDir('[COLORblue][B]FAVORITES[/B][/COLOR]','Favorites',4,'http://goo.gl/TyDD6w',FANART,'','','','')
    if addon.getSetting("watchmovies") == "true":
            Menu('[COLORblue][B]BAMFS MOVIES[/B][/COLOR]','http://onlinemoviescinema.com/movies/',1000,icon,FANART,'','')

...
def deleteDB():
    try:
        xbmc.log("[plugin.video.gtv] Deleting database...", xbmc.LOGDEBUG)
        dbPath = xbmc.translatePath(xbmcaddon.Addon(id = 'plugin.video.gtv').getAddonInfo('profile'))
        ...
        if passed:
            xbmc.log("[plugin.video.gtv] Deleting database...PASSED", xbmc.LOGDEBUG)
        else:
            xbmc.log("[plugin.video.gtv] Deleting database...FAILED", xbmc.LOGDEBUG)

        return passed

    except Exception, e:
        xbmc.log('[plugin.video.gtv] Deleting database...EXCEPTION', xbmc.LOGDEBUG)
        return False
